...
/**
 * This interface helps to "refactor" your code. You have your own specified code, but code being
 * into the main method should follow certain rules. And by implementing this interface, you will be
 * able to arrange your individual code in a standard way.
 *
 * @param <Doc> could be the bridge between what is required and your code.
 */
